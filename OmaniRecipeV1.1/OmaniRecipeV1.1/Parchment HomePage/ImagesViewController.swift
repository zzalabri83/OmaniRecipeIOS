...
class ImagesViewController: UIViewController {
  ...
  init(images: [UIImage], options: PagingOptions) {
    ...
    //Here to register a new collectionviewCell
    
//    collectionView.register(
//      ImageCollectionViewCell.self,
//      forCellWithReuseIdentifier: ImageCollectionViewCell.reuseIdentifier)
//    self.collectionView.register(UINib(nibName: "ImageCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: ImageCollectionViewCell.reuseIdentifier)
    collectionView.register(
        ImageCollectionViewCell.self,
        forCellWithReuseIdentifier: ImageCollectionViewCell.reuseIdentifier)
  }
...
//    let imageView = UIImageView(image: images[indexPath.item])
    ...
    //cell.imageCell = imageView //images[indexPath.item]
    return cell
  }
